                        ...
                        <tr>
                            ...
                            <td class="text-end text-nowrap">
                                <div class="d-inline-flex gap-2 align-items-center">
                                    ...
                                    <a href="{{ route('eventos.planejamento.pdf', $ev) }}" target="_blank" rel="noopener noreferrer" class="btn btn-sm btn-outline-danger" title="Ver Planejamento de Ação">Ver Planejamento de Ação</a>
